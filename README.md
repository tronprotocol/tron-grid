...
TronnGrid v3 (TG3) will use api versioning moving forward. As this is the first iteration of the imporved TronGrid, we will start with **v1**. ex: `https://api.trongrid.io/v1`
